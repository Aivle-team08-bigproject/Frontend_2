...
export default function TestDashboard() {
  ...
  const liveAlerts = data.priority_cards.map((card) => { const action = data.priority_actions.find((item) => item.priority_code === card.priority_code); return [card.label, action?.title ?? '조치 대기 작업', `${card.count}건`, card.detail_route] as const })
