...
export default function SignupPage() {
  ...
  if (submitted) {
    return (
      <LoginScreen>
        <LoginCard>
          <SignupHeader><span>DATA FORGE</span><Title>가입 신청 완료</Title><SignupNote>목업 신청이 완료되었습니다.</SignupNote></SignupHeader>
          <SuccessBox>
      ...
      <LoginCard>
        ...
        <Form onSubmit={handleSubmit}>
          <FormGrid>
            ...
            <Field>회사 이메일<Input type="email" value={form.email} onChange={(event) => update('email', event.target.value)} placeholder="name@example.com" autoComplete="email" /></Field>
