...
export default function LoginPage() {
  ...
  return (
    <LoginScreen>
      <LoginCard>
        <Brand>
          <BrandPill><BrandMark />HANA CARD</BrandPill>
        ...
        <Form onSubmit={handleSubmit}>
          <Field>
            직원 ID
            <InputWrap><Icon><UserIcon /></Icon><Input value={employeeCode} onChange={(event) => setEmployeeCode(event.target.value)} placeholder="DEMO-2024-089" autoComplete="username" /></InputWrap>
          </Field>
          <Field>
            비밀번호
