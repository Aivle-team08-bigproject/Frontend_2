...
const termsSections: SectionData[] = [
  ...
  { id: 'terms-12', title: '제12조 약관 변경·통지·준거법·분쟁 처리', body: '약관의 시행일, 개정일 및 주요 변경 내용은 서비스에서 안내합니다. 회원에게 불리하거나 중요한 변경은 적용일 전에 별도 공지하며, 서비스 이용 문의와 분쟁은 포트폴리오 데모 개인정보보호 담당부서(privacy@example.com, 02-0000-0000)와 회사 내부 절차를 통해 처리합니다. 본 약관은 대한민국 법령에 따릅니다.' },
]

const privacySections: SectionData[] = [
  { id: 'privacy-1', title: '1. 개인정보 처리자 및 보호책임자', body: '개인정보 처리자는 포트폴리오 데모 서비스입니다. 개인정보보호 담당부서는 개인정보 보호 업무와 권리행사 문의를 담당합니다.', table: { headers: ['구분', '내용'], rows: [['처리자', '포트폴리오 데모 서비스'], ['주소', '서울특별시 중구 을지로 66'], ['담당부서', '포트폴리오 데모 개인정보보호 담당부서'], ['문의·권리행사', 'privacy@example.com / 02-0000-0000']] } },
  ...
  { id: 'privacy-9', title: '9. 정보주체의 권리와 행사방법', body: '회원은 개인정보 열람, 정정, 삭제, 처리정지를 요청할 수 있습니다. privacy@example.com 또는 02-0000-0000으로 요청하면 본인 확인, 대상 정보 확인, 처리 결과 통지 순서로 법정 처리기간 내 처리합니다. 대리 요청은 위임 관계와 대리인의 신원을 확인합니다.' },
  ...
  { id: 'privacy-12', title: '12. 문의·신고·권리행사 연락처', body: '개인정보 보호 및 권리행사 문의는 포트폴리오 데모 개인정보보호 담당부서 privacy@example.com 또는 02-0000-0000으로 접수할 수 있습니다. 개인정보 침해 신고·상담은 관계 기관의 공식 신고 채널을 이용할 수 있습니다.' },
]
